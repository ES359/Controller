...
public class Functions extends Inform {
    ...
    public void enableFly(Player target, Player sender) {
        ...
        sender.sendMessage("&7Set &bflight &7to &aEnabled &7for &3" + target.getName() + "&c.");
    ...
    public void disableFly(Player target,Player sender) {
        ...
        sender.sendMessage("&7Set &bflight &7to &cDisabled &7for &3" + target.getName() + "&c.");
    }
